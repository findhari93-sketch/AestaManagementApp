-- Migration: Smart Category Mapping for Miscellaneous Expenses
-- Purpose: Map miscellaneous expense categories to their corresponding expense types
-- This allows miscellaneous expenses to appear under correct categories in All Site Expenses view
-- Example: "Tea & Snacks Settlement" category will show as "Tea & Snacks" expense type
...
FROM "public"."tea_shop_settlements" "ts"
    ...
    LEFT JOIN LATERAL (
        ...
        ORDER BY
            CASE WHEN "tsa2"."site_id" IS NOT NULL THEN 0 ELSE 1 END,
...
-- Miscellaneous expenses (UPDATED with smart category mapping)
SELECT
    "me"."id",
    ...
    -- SMART CATEGORY MAPPING: Map category names to corresponding expense types
    (CASE
