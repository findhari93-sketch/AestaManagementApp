-- Update ingest_purchase_atomic to set source='ai_ingest' on the expense row.
-- Requires migration 20260510170000 (source column) to have been applied first.
...
BEGIN
  ...
  IF NOT v_catalog_only THEN
    ...
    -- is_paid=true: bill already received; surfaces immediately on expenses page
    -- source='ai_ingest': identifies origin for the Origin filter on /site/material-expenses
    ...
    VALUES (
      ...
      auth.uid(),
      true, v_purchase_date, 'ai_ingest'
    )
