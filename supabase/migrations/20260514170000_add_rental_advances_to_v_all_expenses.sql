-- Add rental_advances to v_all_expenses so advance payments appear in site expenses
-- under Machinery → "Rental Advance - <vendor>" on their advance_date.
-- The final settlement (rental_settlements) was already restored in 20260513100000.
-- This extends the view with a new UNION ALL for rental_advances.
...
UNION ALL
-- Rental settlements: restored in 20260513100000, preserved here.
 SELECT rs.id,
    ro.site_id,
...
UNION ALL
-- NEW: Rental advances — appear on advance_date under Machinery / "Rental Advance - <vendor>"
 SELECT ra.id,
    ro.site_id,
...
COMMENT ON VIEW v_all_expenses IS
  'Unified expenses view. v2.2 (2026-05-14): added rental_advances UNION so advance payments appear under Machinery on their advance_date.';
