-- Migration: Fix material expense amount in v_all_expenses view
-- Purpose: Use amount_paid (bargained amount) instead of total_amount for settled material purchases
-- When a vendor payment is made, the actual amount paid (after bargaining) should be recorded

-- Drop and recreate v_all_expenses view with corrected material purchase amount
...
-- FIXED: Use amount_paid (bargained amount) when available, fall back to total_amount
SELECT
    "mpe"."id",
    "mpe"."site_id",
