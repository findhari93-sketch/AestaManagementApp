-- Migration: Update smart category mapping for merged Material Expenses category
-- Purpose: Add "Material Expenses" to the expense_type mapping in v_all_expenses view
...
-- Miscellaneous expenses (UPDATED with smart category mapping including new Material Expenses)
SELECT
    "me"."id",
    ...
    -- Updated to include new "Material Expenses" merged category
    (CASE
