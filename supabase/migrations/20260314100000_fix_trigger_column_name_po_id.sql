-- Fix: update_stock_on_verified_delivery trigger references poi.purchase_order_id
-- but the actual column in purchase_order_items is po_id.
-- This causes a runtime error on every delivery_items INSERT, returning a 400.
