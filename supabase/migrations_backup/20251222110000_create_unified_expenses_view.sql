-- Migration: Create unified expenses view (v_all_expenses)
-- Purpose: Single source of truth combining regular expenses with derived salary expenses

-- ============================================================================
-- 1. Create the unified expenses view
-- ============================================================================
...
-- Add comment
COMMENT ON VIEW v_all_expenses IS 'Unified view combining regular expenses with derived salary expenses from settlement_groups. Use this instead of querying expenses table directly for complete expense data.';
