...
import type { SalaryPageData, SalaryPeriodDetailed } from "@/lib/data/salary";
...
export default function SalaryContent({ initialData }: SalaryContentProps) {
  // Initialize state with server data
  const [salaryPeriods, setSalaryPeriods] = useState<SalaryPeriodDetailed[]>(
    initialData.salaryPeriods
  );
