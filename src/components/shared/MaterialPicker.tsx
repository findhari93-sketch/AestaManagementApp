...
const CREATE_NEW_ID = "__create_new_material__";
...
type Option = MaterialWithDetails | CreateNewSentinel;
...
interface MaterialPickerProps {
  value: MaterialWithDetails | null;
  onChange: (material: MaterialWithDetails | null) => void;
...
export function MaterialPicker({
  ...
  const options: Option[] = useMemo(() => {
    ...
    return base;
  }, [materials, inputValue, onCreateNew]);
  ...
  return (
    <Autocomplete<Option, false, false, false>
      ...
      isOptionEqualToValue={(option, val) => {
        ...
        return (option as MaterialWithDetails).id === (val as MaterialWithDetails).id;
      }}
      filterOptions={(opts, state) => {
        ...
        return opts.filter((o) => {
          ...
          return (
            ...
            (o.local_name || "").toLowerCase().includes(q)
          );
        });
      }}
        ...
        return (
          ...
          >
            ...
            <Box sx={{ minWidth: 0, flex: 1 }}>
              ...
              >
                {[option.code, option.unit, option.category?.name].filter(Boolean).join(" · ")}
              </Typography>
            </Box>
          </Box>
        );
